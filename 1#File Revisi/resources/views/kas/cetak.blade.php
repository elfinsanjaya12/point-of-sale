...
@section('print')
  ...
  <table class="table table-bordered" width="100%">
    <thead style="text-align: center;">
      <th style="text-align: center;">Nomor</th> <!-- style="width: 3px; text-align: center;" -->
  ...
  <table class="table table-bordered">
    <td width="50%"><b>Total Debit</b></td>    
    <td width="18%" style="text-align: center;"><b>Rp. {{number_format($total_debit,0,',','.')}}</b></td>
    <td></td>    
  </table>
  <table class="table table-bordered">
    <td width="68%"><b>Total Kredit</b></td>
    <td width="14%" style="text-align: center;"><b>Rp. {{number_format($total_kredit,0,',','.')}}</b></td>
    <td></td>
  </table>  
  <table class="table table-bordered">
    <td><b>Saldo Kas</b></td>
    <td width="18%" style="text-align: center;"><b>Rp. {{number_format($kas_total,0,',','.')}}</b></td>
  </table>
    <br>
