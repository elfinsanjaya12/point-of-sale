              ...
              <?php $i=1; foreach ($detailPembelian as $detailBarang):  ?>
                <tr>
                  ...
                  <td style="text-align: center;">                                
                      ...
                      <a href="{{{ URL::to('penjaga/pembelian/tambah/'.$detailBarang->id.'/hapus') }}}" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus data {{{($i).' - '.($detailBarang->nama_barang) }}}?')" class="btn btn-danger btn-fill btn-xs">
