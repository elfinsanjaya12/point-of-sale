...
@section('print')
  ...
  <table class="table table-bordered" width="100%">
    ...
    <tr>
      ...
      <td class="text-center">{{rupiah($penjualan->total_bayar)}}</td> 
      <td class="text-center">{{rupiah($penjualan->total_kembalian)}}</td>      
    </tr>
  @endforeach
  </tbody>
  </table>
  <table class="table table-bordered">
    <td>Total</td>
    <td width="20%" style="text-align: right;">{{rupiah($harga_total)}}</td>
  </table>
  <br>
